...
public class BusConstants {
	...
	public static final String TASK_REMARK_COMMIT = "请为新订单维护海外用户收款账户信息";
	//订单海外用户信息已维护发送审核员复审
	...
	public static final String TASK_REMARK_FIRST_HCPAY = "请维护国内外账户信息，并根据单据信息进行线下支付";
	//打款完成后发送待办至平台操作员进行第一次打款确认
	public static final Integer TASK_TYPE_CONFIRM_FIRST_HCPAY = 5; 
	public static final String TASK_REMARK_CONFIRM_FIRST_HCPAY = "请核实华创用户第一次打款信息";
	//平台操作员确认创用户第1次付款凭证有误 驳回
	public static final Integer TASK_TYPE_FIRST_HCPAY_VOUCHER_REJECT = 6; 
	public static final String TASK_REMARK_FIRST_HCPAY_VOUCHER_REJECT = "您上传的付款凭证有误，请核实";
	...
	public static final String TASK_REMARK_FIRST_HCPAY_VOUCHER_CHECK = "请复核华创用户第一次打款信息";
	//平台审核员审核无误后，发送待办至海外用户进行收款确认并上传凭证
	public static final Integer TASK_TYPE_FIRST_MONEYRECEIPT = 8; 
	public static final String TASK_REMARK_FIRST_HCPAY_MONEYRECEIPT = "请根据单据信息进行收款确认";
	//海外用户收款确认后发送待办至平台操作员进行收款凭证确认
	public static final Integer TASK_TYPE_FIRST_MONEYRECEIPT_VOUCHER = 9; 
	public static final String TASK_REMARK_FIRST_MONEYRECEIPT_VOUCHER = "海外用户已确认收到华创第一次打款，请核验收款凭证";
	//平台操作员确认收款凭证有问题，则驳回
	public static final Integer TASK_TYPE_FIRST_MONEYRECEIPT_VOUCHER_REJECT = 10; 
	public static final String TASK_REMARK_FIRST_MONEYRECEIPT_VOUCHER_REJECT = "您上传的收款凭证有误，请核实";
	...
	public static final String TASK_REMARK_FIRST_MONEYRECEIPT_VOUCHER_REJECT_CHECK = "海外用户已确认收到华创第一次打款，请复核收款凭证";
	//如果平台审核员审核无误，则发送待办至好望角操作员进行向华创打款，并上传打款凭证
	public static final Integer TASK_TYPE_HWJPAY = 12; 
	public static final String TASK_REMARK_HWJPAY = "请根据该单据信息进行线下打款";
	//好望角打款并上传凭证后，发送待办至平台操作员进行打款确认
	public static final Integer TASK_TYPE_HWJPAY_CONFIRM = 13; 
	public static final String TASK_REMARK_HWJPAY_CONFIRM = "好望角用户已完成RMB打款，请核验打款凭证信息";
	//平台操作员接收到好望角打款确认待办进行确认，如果有问题则驳回
	public static final Integer TASK_TYPE_HWJPAY_CONFIRM_REJECT = 14; 
	public static final String TASK_REMARK_HWJPAY_CONFIRM_REJECT = "您上传的打款凭证有误，请核实";
	...
	public static final String TASK_REMARK_HWJPAY_CONFIRM_CHECK = "好望角用户已完成RMB打款，请复核打款凭证";
	//平台审核员如果审核好望角打款确认凭证无误，则发送待办至华创操作员进行收款确认并上传收款凭证
	public static final Integer TASK_TYPE_HWJPAY_HCRECEIPT_CONFIRM = 16; 
	public static final String TASK_REMARK_HWJPAY_HCECEIPT_CONFIRM = "请根据单据信息对您的来款进行收款确认";
	//华创用户上传收款凭证后，发送待办至平台操作员进行信息核实
	public static final Integer TASK_TYPE_HWJPAY_HCRECEIPT_VOUCHER = 17; 
	public static final String TASK_REMARK_HWJPAY_HCRECEIPT_VOUCHER = "华创客户已对好望角来款进行确认，请核实收款凭证信息";
	//华创用户上传收款凭证如果有误，则驳回
	public static final Integer TASK_TYPE_HWJPAY_HCRECEIPT_VOUCHER_REJECT = 18; 
	public static final String TASK_REMARK_HWJPAY_HCRECEIPT_VOUCHER_REJECT = "您上传的收款凭证有误，请核实";
	...
	public static final String TASK_REMARK_HWJPAY_HCRECEIPT_VOUCHER_CHECK = "华创客户已对好望角来款进行确认，请复核收款凭证信息";
	//平台审核员审核华创收款凭证没有问题，则发送待办至华创操作员进行第二次打款
	public static final Integer TASK_TYPE_SECOND_HCPAY = 20; 
	public static final String TASK_REMARK_SECOND_HCPAY = "请根据单据信息进行第二次线下打款";
	//华创2次打款完成，并上传凭证后发送待办至平台操作员进行核验打款凭证
	public static final Integer TASK_TYPE_SECOND_HCPAY_CONFIRM = 21; 
	public static final String TASK_REMARK_SECOND_HCPAY_CONFIRM = "华创用户已完成二次打款操作，请核验打款凭证信息";
	//平台操作员核验华创2次打款凭证后，如有问题则驳回
	public static final Integer TASK_TYPE_SECOND_HCPAY_CONFIRM_REJECT = 22; 
	public static final String TASK_REMARK_SECOND_HCPAY_CONFIRM_REJECT = "您上传的打款凭证有误，请核实";
	...
	public static final String TASK_REMARK_SECOND_HCPAY_RECHECK = "华创用户已完成二次打款操作，请复核打款凭证信息";
	//平台审核员复核华创2次打款凭证无误则发送待办至海外用户进行确认收款
	public static final Integer TASK_TYPE_SECOND_HCPAY_RECEIPT_CONFIRM = 24; 
	public static final String TASK_REMARK_SECOND_HCPAY_RECEIPT_CONFIRM = "已完成第二次打款，请根据单据信息确认收款";
	//海外用户确认收款后上传凭证并发送待办至平台操作员进行凭证确认核实
	public static final Integer TASK_TYPE_SECOND_HCPAY_RECEIPT_VOUCHER = 25; 
	public static final String TASK_REMARK_SECOND_HCPAY_RECEIPT_VOUCHER = "海外用户已完成第二次收款确认，请核实收款凭证信息";
	//平台操作员核实海外用户二次收款凭证有问题，则驳回
	public static final Integer TASK_TYPE_SECOND_HCPAY_RECEIPT_VOUCHER_REJECT = 26; 
	public static final String TASK_REMARK_SECOND_HCPAY_RECEIPT_VOUCHER_REJECT = "您上传的收款凭证存在问题，请核实";
	...
	public static final String TASK_REMARK_SECOND_HCPAY_RECEIPT_VOUCHER_RECHECK = "海外用户已完成第二次收款确认，请复核收款凭证信息";
	//平台审核员复核海外用户二次收款凭证及华创海外账户信息没有问题，则发送待办至海外用户进行第一次海外打款
	public static final Integer TASK_TYPE_FIRST_HWUSERPAY = 28; 
	public static final String TASK_REMARK_FIRST_HWUSERPAY = "请根据单据信息进行第一次海外打款";
	//海外用户第一次打款完成并上传打款凭证，则发送待办至平台操作员进行打款信息核实
	public static final Integer TASK_TYPE_FIRST_HWUSERPAY_CONFIRM = 29; 
	public static final String TASK_REMARK_FIRST_HWUSERPAY_CONFIRM = "海外用户已向华创海外账户第一次打款，请核实打款凭证信息";
	//平台操作员审核海外用户第一次打款凭证有问题，则驳回至海外用户
	public static final Integer TASK_TYPE_FIRST_HWUSERPAY_REJECT = 30; 
	public static final String TASK_REMARK_FIRST_HWUSERPAY_REJECT = "您上传的第一次海外打款凭证有问题，请核实";
	...
	public static final String TASK_REMARK_SECOND_HWUSERPAY = "请根据单据信息进行海外账户第二次打款";
	//海外用户第二次打款完成并上传打款凭证，发送待办至平台操作员进行凭证核实
	public static final Integer TASK_TYPE_SECOND_HWUSERPAY_CONFIRM = 45; 
	public static final String TASK_REMARK_SECOND_HWUSERPAY_CONFIRM = "海外用户已完成华创用户海外账户二次打款操作，请核验打款凭证信息";
	//平台操作员核验海外用户2次打款凭证，存在问题，则驳回
	public static final Integer TASK_TYPE_SECOND_HWUSERPAY_REJECT = 46; 
	public static final String TASK_REMARK_SECOND_HWUSERPAY_REJECT = "您上传的海外打款凭证有误，请核实";
	...
	public static final String TASK_REMARK_SECOND_HWUSERPAY_RECHECK = "海外用户已完成华创用户海外账户二次打款操作，请复核打款凭证信息";
	...
	public static final String TASK_REMARK_CUSTOMER_PAY_REJECT = "您上传的打款凭证有误，请核实";
	...
	public static final String TASK_REMARK_HWUSER_RECEIPT_REJECT = "您上传的收款凭证有误，请核实";
	...
	public static final String TASK_REMARK_HWUSER_PAY_REJECT = "您上传的打款凭证有误，请核实";
	...
	public static final String TASK_REMARK_CUSTOMER_RECEIPT_REJECT = "您上传的收款凭证有误，请核实";
